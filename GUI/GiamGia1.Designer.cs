namespace GUI
{
    partial class GiamGia1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label7 = new Label();
            label8 = new Label();
            lb_loaigiamgia = new LinkLabel();
            lb_mucgiam = new LinkLabel();
            lb_ngaybatdau = new LinkLabel();
            lb_trangthai = new LinkLabel();
            panel1 = new Panel();
            ...
            // lb_loaigiamgia
            // 
            lb_loaigiamgia.AutoSize = true;
            lb_loaigiamgia.LinkColor = Color.Red;
            lb_loaigiamgia.Location = new Point(228, 278);
            lb_loaigiamgia.Margin = new Padding(4, 0, 4, 0);
            lb_loaigiamgia.Name = "lb_loaigiamgia";
            lb_loaigiamgia.Size = new Size(0, 25);
            lb_loaigiamgia.TabIndex = 84;
            // 
            // lb_mucgiam
            // 
            lb_mucgiam.AutoSize = true;
            lb_mucgiam.LinkColor = Color.Red;
            lb_mucgiam.Location = new Point(228, 364);
            lb_mucgiam.Margin = new Padding(4, 0, 4, 0);
            lb_mucgiam.Name = "lb_mucgiam";
            lb_mucgiam.Size = new Size(0, 25);
            lb_mucgiam.TabIndex = 85;
            // 
            // lb_ngaybatdau
            // 
            lb_ngaybatdau.AutoSize = true;
            lb_ngaybatdau.LinkColor = Color.Red;
            lb_ngaybatdau.Location = new Point(173, 556);
            lb_ngaybatdau.Margin = new Padding(4, 0, 4, 0);
            lb_ngaybatdau.Name = "lb_ngaybatdau";
            lb_ngaybatdau.Size = new Size(0, 25);
            lb_ngaybatdau.TabIndex = 86;
            // 
            // lb_trangthai
            // 
            lb_trangthai.AutoSize = true;
            lb_trangthai.Location = new Point(619, 364);
            lb_trangthai.Margin = new Padding(4, 0, 4, 0);
            lb_trangthai.Name = "lb_trangthai";
            lb_trangthai.Size = new Size(0, 25);
            lb_trangthai.TabIndex = 88;
            // 
            // panel1
            // 
            panel1.BackColor = SystemColors.ControlLightLight;
            panel1.BorderStyle = BorderStyle.FixedSingle;
            panel1.Controls.Add(lb_trangthai);
            panel1.Controls.Add(lb_ngaybatdau);
            panel1.Controls.Add(lb_mucgiam);
            panel1.Controls.Add(lb_loaigiamgia);
        ...
        private LinkLabel lb_loaigiamgia;
        private LinkLabel lb_mucgiam;
        private LinkLabel lb_ngaybatdau;
        private LinkLabel lb_trangthai;
